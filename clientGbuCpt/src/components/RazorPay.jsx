  ...
  const checkoutHandler = async () => {
    try {
      ...
      const  {data}  = await axios.post(
        "https://1j9g2haxne.execute-api.ap-south-1.amazonaws.com/dev/createOrder", {
      ...
      const options = {
        ...
        handler: function (response) {
          ...
          axios
            .post("https://1j9g2haxne.execute-api.ap-south-1.amazonaws.com/dev/verifyOrder", paymentData)
